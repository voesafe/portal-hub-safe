...
const RBAC_MODULOS = [
  ...
  { id: 'fechamento_horas_instrutores', nome: 'Fechamento de Horas / Instrutores', nota: 'valor da hora dos instrutores Eventual',
    ver: ['fechamento_horas_instrutores.visualizar'],
