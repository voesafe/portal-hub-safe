...
Cohesion: 0.29
Nodes (5): api() — fetch wrapper to container-bound GAS backend, carregarEscala(), carregarFinanceiro(), carregarPAVs(), entrarNoApp()
